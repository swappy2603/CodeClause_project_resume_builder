...
public class personalinfo extends JFrame {
	...
	public personalinfo() {
		...
		lblFirstName_2 = new JLabel("Email");
		...
		textField_2.setBounds(52, 297, 693, 33);
		contentPane.add(textField_2);
		
		lblFirstName_3 = new JLabel("Phone");
		...
		lblFirstName_4 = new JLabel("Nationality");
		...
		lblFirstName_5 = new JLabel("Address");
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				Experince Ec= new Experince();
				Ec.setVisible(true);
				dispose();
				Ec.firstname=textField_1.getText();
				Ec.lastname=textField_6.getText();
				Ec.email=textField_2.getText();
				Ec.phone=textField_3.getText();
				Ec.nationality=textField_4.getText();
				Ec.address=textField_5.getText();
			}
		});
